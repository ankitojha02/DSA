...
// // Flatten a Multilevel Doubly Linked List - LeetCode Problem - Using
// Recursion
...
// // Time complexity of flatten function is O(n) where n is the number of nodes
// in the multilevel doubly linked list. This is because we are visiting each
// node exactly once during the flattening process.
...
// return map.get(head);
// }
// Time Complexity of copyRandomList function is O(n) where n is the number of
// nodes in the linked list. This is because we are visiting each node exactly
// twice: once to create the new nodes and once to set the next and random
// pointers.
